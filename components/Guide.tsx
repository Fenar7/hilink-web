  ...
  return (
    <section className='flexCenter flex-col'>
      ...
      <div className='flexCenter max-container relative w-full'>
        ...
        width={1440}
        height={580}
        className='w-full object-cover object-center 2xl:rounded-5x1 travel-card'
        />

        <div className='absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3x1
        border shadow-md md:left-[5%] lg:top-20 rounded2'>
          <Image
          src="/meter.svg"
          alt="meter"
          width={16}
          ...
          <div className='flexBetween flex-col'>
            <div className='flex w-full flex-col'>
              ...
              <p className='bold-20 mt-2'>Aguas Coliantas</p>
            </div>
