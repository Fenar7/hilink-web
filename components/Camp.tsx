...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}:CampProps) =>{
  return(
    ...
    bg-cover bg-no-repeat lg:rounded-r-5x1 2x1:rounded-5x1 travel-card`}>
  ...
  return (
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        <div className='bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5x1 xl:px-16 xl:py-20
        relative w-full overflow-hidden rounded-3xl'>
          <h2 className='regualar-24 md:regular-32 2xl:regular-64 capitalize text-white'>
